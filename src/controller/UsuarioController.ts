...
export abstract class UsuarioController {
    ...
    // public cadastrar(id: number, nome: string, email: string, senha: string, telefone: string, tipo: string): void {
    //     let usuario: Cliente | Admin;
    //     if (tipo !== '1') {
    //         usuario = new Cliente();
    //     } else {
    //         usuario = new Admin();
    ...
    public iniciar(): void {
        ...
        do {
            ...
            //         this.cadastrar(id, nome, email, senha, telefone, tipo);
            //         break;
            //     }
            //     case '2': {
            //         const email = readlineSync.question("Digite o seu email: ");
